...
export const list = [
	...
	},
	{
		...
		descriptionShort: "They're Mean, Moist and Loaded for Action!",
		cover: '/bilder/artiklar/liten/PS-worms_S.jpg?m=1604303245',
	},
	{
		artnr: 'PS-wing-commander-3-heart',
		product: 'Wing Commander 3 Heart of the Tiger',
		description:
			"The war against the Kilrathi is going badly for the Confederation. Its flagship, the Concordia, has been destroyed, battles are lost on all fronts. War hero Colonel Christopher Blair is transferred to the old carrier Victory. Take the role of Blair and ensure the success of the Confederation's last-ditch attempt for victory: the destruction of the Kilrathi homeworld.<br><br>Wing Commander III has the usual mix of space battles and cinematic storytelling. Changes from the first two games include SVGA graphics, the use of texture-mapped polygons instead of bitmaps for spaceflight sequences and real Hollywood actors appearing in the cinematic scenes.<br>",
		descriptionShort:
			'You are the star – Your actions will determine the eventual outcome',
		cover:
			'/bilder/artiklar/liten/PS-wing-commander-3-heart_S.jpg?m=1604303225',
	},
	{
		artnr: 'PS-urban-chaos',
		product: 'Urban Chaos',
		description:
			"As the 2nd millennium ends, the cities are over-ran with Apocalyptic violence. Is this down to urban frustrations, or a sinister cult controlling everybody? You are either cop D'Arcy Stern or former soldier Roper McIntyre, and have to find the answers, but more importantly put a stop to the carnage.<br><br>This involves a succession of action-packed non-linear missions. The environment incorporates shadows, rain, fog and a day/night cycle. Police cars, motorcycles and ambulances must be controlled during some missions. There are many ways to 'settle' the enemies - car chases, hand-to-hand combats and action movie-style shoot outs for example.<br>",
		descriptionShort:
			'Urban Chaos throws you into the heart of this modern urban jungle at the turn of the millennium',
		cover: '/bilder/artiklar/liten/PS-urban-chaos_S.jpg?m=1603087949',
	},
	{
		artnr: 'PS-tony-hawks-pro-skater-',
		product: "Tony Hawk's Pro Skater 4",
		description:
			"Tony Hawk's Pro Skater 4 is the fourth game in Activision's skateboarding franchise.<br><br>The main feature of this game is it's redesigned career mode. When beginning a level, you have all the time in the world to skate around, perform tricks, get a feel for the level, without the hassel of any goals or time limits. When you're ready to attempt a goal, simply find a pro skater, talk to him, then receive the goal, similar to Dave Mirra Freestyle BMX. Goals are similar to the previous games, such as collect SKATE, get a certain amount of points, transfer over this and grind that. There are new goals, however, such as collecting the word COMBO while doing one big combo. Miss a trick, and goal fails. Once all regular goals are accomplished, you can attempt the Pro Goal, which is specific to each skater, and is extremely hard.<br><br>All the major skaters are here, including Tony Hawk, Bob Burnquist, Steve Caballero, Kareem Campbell, Rune Gilfberg, Eric Koston, Bucky Lasek, Bam Margera, Rodney Mullen, Chad Muska, Andrew Reynolds, Geoff Rowley, Elissa Steamer and Jamie Thomas.<br>",
		descriptionShort: 'Nollie 180 Heelflip. Piece of cake.',
		cover:
			'/bilder/artiklar/liten/PS-tony-hawks-pro-skater-_S.jpg?m=1604303175',
	},
	{
		artnr: 'PS-tony-hawks-pro-skater',
		product: "Tony Hawk's Pro Skater",
		description:
			"Tony Hawk's Pro Skater is a skateboarding simulation in which you control a famous skate star around 3D environments. Each game area contains a plethora of objects like ramps, rails, and half-pipes which can be used to perform tricks. Each trick you perform earns you more points for your score.<br><br>The game is divided into two types of levels. In the first, you skate around locations like a mall, a city street, or a warehouse. In each of these areas, there are 5 goals to complete. Some goals involve obtaining a high score, others smashing objects, and some collecting objects. For every goal you complete, you earn a video tape. By collecting enough video tapes, you unlock levels and skateboards for you to use. There are 6 levels like this. The second type of level is a competition. You get to make 3 timed runs through a skate park, and attempt to get the highest score possible. If you do well enough, you will beat the scores of the computer controlled skaters and win a medal. There are 3 levels like this.<br><br>There are nine real life pro skaters you can choose to play as, including Tony Hawk himself. Each skater has their own signature moves that earn you big points if pulled off successfully.<br>",
		descriptionShort:
			'Skate as legendary Tony Hawk, or as one of nine top pros',
		cover: '/bilder/artiklar/liten/PS-tony-hawks-pro-skater_S.jpg?m=1604303158',
	},
	{
		artnr: 'PS-tomb-raider-iv-the-las',
		product: 'Tomb Raider IV: The Last Revelation',
		description:
			"According to Egyptian legend, Horus outwitted the evil god Set and imprisoned him in a secret tomb...<br><br>Five thousand years later, Lara Croft discovers the lost tomb and unwittingly unleashes the Set, fulfilling the ancient prophecy of his return to plunge mankind into darkness! In a race against time, Lara must use all of her wit and skill to reimprison Set and save the world from Armageddon. Pursued at every turn by her arch-rival, the unscrupulous archaeologist Werner Von Croy, Lara embarks on a journey of discovery across Egypt, where she must overcome the most ingenious puzzles and infernal traps ever devised, and face terrifying evil from beyond the grave...<br><br>Tomb Raider: The Last Revelation plays very similar to the previous games in the series, but some new things have been added to the game. The biggest addition is that now rather large parts of the game consist of several interconnected levels sometimes explored in any order, with puzzles in one level often requiring that some actions are done in other levels. The new additions to Lara's arsenal are a revolver and a bow with several sets of arrows including exploding and poisonous ones. The players will also find a laser sight which can be attached to any of the two weapons described above allowing manual targeting and zooming. Inventory now holds a binocular with built-in flashlight and a handy crowbar (found later in the game). Lara has also learned a few new moves: she can climb into the niches with low ceiling if the crouch button is pressed, she can now move around the corners while hanging and she can also pull levers and open trap-doors while jumping.<br><br>Graphics have been upgraded too - there are new light effects and water is now dripping from Lara's clothes when she gets on surface.<br>",
		descriptionShort:
			'In a race against time, Lara must use all her wit and skill to save the world from Armageddon!',
		cover:
			'/bilder/artiklar/liten/PS-tomb-raider-iv-the-las_S.jpg?m=1604303142',
	},
	{
		artnr: 'PS-tomb-raider-ii',
		product: 'Tomb Raider II',
		description:
		...
		descriptionShort:
			'Join Lara as she travels around the globe to retrieve a precious artefact before it falls into the wrong hands',
		cover: '/bilder/artiklar/liten/PS-tomb-raider-ii_S.jpg?m=1604303128',
	},
	{
		artnr: 'PS-tomb-raider-chronicles',
		product: 'Tomb Raider Chronicles',
		description:
		...
		descriptionShort: 'Lara Croft is missing in Egypt - presumed dead',
		cover:
			'/bilder/artiklar/liten/PS-tomb-raider-chronicles_S.jpg?m=1604303101',
	},
	{
		artnr: 'PS-tomb-raider-3-adventur',
		product: 'Tomb Raider 3: Adventures of Lara Croft',
		description:
			"The intrepid archaeologist Lara Croft ventures to India, searching for a legendary stone that once belonged to the tribe of Infada. Shortly after recovering the precious stone, she encounters a Dr. Willard, the head of an organization known as RX Tech. Willard is interested in an ancient Polynesian city built by people of a now defunct civilization, which worshipped a mysterious meteorite that hit the Earth millions of years ago. Willard tells Lara that the Infada Stone is in fact one of the four artifacts the ancient Polynesians fashioned from the material contained in the meteorite's core. Willard suggests Lara should look for the other three, scattered and hidden in various regions of the planet. It looks like another dangerous adventure awaits the fearless 'tomb raider'!<br>",
		descriptionShort: 'Lara is ready for anything. Prepare to be amazed!',
		cover:
			'/bilder/artiklar/liten/PS-tomb-raider-3-adventur_S.jpg?m=1604303086',
	},
	{
		artnr: 'PS-tomb-raider-1996',
		product: 'Tomb Raider',
		description:
		...
		cover: '/bilder/artiklar/liten/PS-tomb-raider-1996_S.jpg?m=1604303067',
	},
	{
		artnr: 'PS-theme-park',
		product: 'Theme Park',
		description:
			"Dominating the exciting world of Theme Park ownership is your goal in this strategy game from Bullfrog. The first task is to set up your rides within the available land, structuring convenient paths and queues and ideally leaving some space for bigger rides once they become available, and include some lakes and trees to increase the park's allure. Rides range from Teacups and Haunted Houses to the biggest most elaborate roller-coaster you can design, and water rides that loop around other rides.<br><br>Shops must also be included, so that the visitors can buy food, drinks and souvenirs - the cunning player will combine salt, sugar and caffeine settings to maximize consumer interest. Staff must be hired to keep everything running smoothly, and they will only work for what they consider a fair rate of pay.<br><br>You are competing against other Theme Parks, so don't let them get an advantage over you - monitor your success in attracting customers and financial viability closely using the supplied statistics pages. More important, ensure that research is adequately funded to produce new rides.<br><br>It can be played in three modes - Sandbox level lets you concentrate on the park design elements, while Sim and Full add more strategic features.<br>",
		descriptionShort:
			'Think you can design and build the greatest amusement park in the world?',
		cover: '/bilder/artiklar/liten/PS-theme-park_S.jpg?m=1603087850',
	},
	{
		artnr: 'PS-theme-hospital',
		product: 'Theme Hospital',
		description:
		...
		descriptionShort: 'Can you balance the books and the bedpans ?',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-BOND1',
		product: 'The World Is Not Enough',
		description:
			"The World Is Not Enough is a first-person shooter based on MGM's 1999 James Bond film of the same name, where the player assumes the role of James Bond through 11 different missions.",
		descriptionShort:
			"Experience the intensity of being the world's top secret agent",
		cover: '/bilder/artiklar/liten/PS-BOND1_S.jpg?m=1602663820',
	},
	{
		artnr: 'PS-the-neverhood',
		product: 'The Neverhood',
		description:
			"You are Klaymen. Klaymen wakes up in a building in the strangely empty world of Neverhood. Initially, he does not know where he is or what he has to do, but as he explores the area, he finds mysterious disks. Each disk contains a fragment of a recording - gradually, the backstory is revealed as Klaymen finds more and more disks. It would spoil too much to reveal the exact plot, as finding it out is part of the game.<br><br>The Neverhood is a point-and-click adventure game, notable for its claymation graphics. It uses a simple interface: you move and interact with the world by clicking on the screen. There is no inventory screen, though Klaymen can find a few items he can pick up. There are few inventory-based puzzles - most of the puzzles involve solving riddles and interacting with the environment.<br><br>Generally, the game is seen from a 3rd person perspective, but when moving between locales, you see the world through Klaymen's eyes (but you have a limited freedom of movement).<br>",
		descriptionShort: 'Embark on a clay adventure that breaks the mold.',
		cover: '/bilder/artiklar/liten/PS-the-neverhood_S.jpg?m=1604303896',
	},
	{
		artnr: 'GB-TETRIS',
		product: 'Tetris',
		...
		descriptionShort: 'Easy to pick up, yet impossible to put down!',
		cover: '/bilder/artiklar/liten/GB-TETRIS_S.jpg?m=1602667495',
	},
	{
		artnr: 'PS-tekken-3',
		product: 'Tekken 3',
		description:
			"Tekken Force, a paramilitary organization protecting the Mishima karate fighters, is nearly obliterated by the might Ogre. Heihachi Mishima's only hope is his grandson Jin Kazama, who lives with his mother Jun, unaware of his legacy. When Ogre attacks his home and presumably kills his mother, Jin seeks out his grandfather and learns the martial arts of the family. On his nineteenth birthday, Heihachi announces the King of the Iron Fist Tournament 3, hoping to use Jin to remove Ogre out of his way.<br><br>Tekken 3 is a versus fighting game similar to its predecessors in the series. Differences include prominently featured side-stepping, allowing characters to retreat into the background and back during fights, new combo throws, and reduced jumping capabilities aiming for more realistic combat. Fifteen new characters have been added to the roster. Also included are two minigames, Tekken Force (a beat-em-up stage that unlocks a new character) and Tekken Ball, a beach volleyball variant where characters are hurt by the ball.<br>",
		descriptionShort:
			'An ancient evil force has reawakened, attacking in secret and feeding on the souls of mighty warriors',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-syphon-filter',
		product: 'Syphon Filter',
		description:
			"Gabriel Logan, one of the government's top covert agents, must neutralize the terrorists that threaten Washington D.C. and destroy a biological weapon that has been built to end the lives of millions of innocent people.<br><br>Syphon Filter is an action game played from the 3rd person. Players take the role of Gabiel Logan as well as other CBDC agents. To successfully complete the mission, players must utilize each of the character's skills accordingly. Logan is able to kneel, crouch, walk, roll, climb, jump and run to meet his objectives.<br><br>The action unfolds over thirteen missions that are chock full of dangers, hazards and puzzles.<br>",
		descriptionShort:
			'Succeed and a major biological disaster is averted. Fail and the whole of our race faces eradication at the hands of genetic terrorists.',
		cover: '/bilder/artiklar/liten/PS-syphon-filter_S.jpg?m=1604304131',
	},
	{
		artnr: 'GB-MARIOLAND',
		product: 'Super Mario Land',
		description:
			"Super Mario Land, the plumber's first outing on the Game Boy, is a side-scrolling platformer much in the vein of the previous Super Mario Bros. This time, Mario must save Princess Daisy, rather than Princess Toadstool, from her kidnapper, Tatanga, a mysterious spaceman.<br><br>The game follows largely the same formula of its aforementioned predecessor, with Mario defeating enemies by jumping on them and collecting coins and power ups by hitting floating blocks, with each world leading up to a boss fight which is defeated using by collapsing the floor. A unique feature of this instalment is two scrolling shoot-'em-up levels, the first of which Mario pilots a submarine, and the second an aeroplane.<br>",
		descriptionShort: 'Join Mario in a world of strange creatures!',
		cover: '/bilder/artiklar/liten/GB-MARIOLAND_S.jpg?m=1602668833',
	},
	{
		artnr: 'N64-SWEP1RACER',
		product: 'Star Wars Episode I: Racer',
		description:
			'Based upon the Pod Racing scenes of Star Wars: Episode I - The Phantom Menace, your mission as young Anakin Skywalker or as one of a collection of strange characters from around the Galaxy is to compete, survive and win in the high speed challenge of Pod Racing.<br><br>Each character has a unique Pod that can be upgraded with the credits you win after each race. Finish first to gain the most prestige and compete in greater and more challenging tracks, including the now famous race along the sand dunes of Tatooine that determined the destiny of many lives.<br>',
		descriptionShort:
			'The fan favorite racer is back featuring motion controls!',
		cover: '/bilder/artiklar/liten/N64-SWEP1RACER_S.jpg?m=1602660469',
	},
	{
		artnr: 'PS-star-wars-dark-forces-',
		product: 'STAR WARS - Dark Forces',
		description:
			"Kyle Katarn is a former Imperial officer turned mercenary, now hired by the Rebel Alliance. After having stolen the Death Star plans from a remote facility, he is tasked with investigating the sudden destruction of a hidden Rebel base. This leads him to face off against Imperial General Rom Mohc and the various iterations of his Dark Troopers - cybernetic soldiers with the armor and firepower to turn the tide of the war.<br><br>Dark Forces is a close prequel to the original Star Wars movie trilogy. The game marks LucasArts' first attempt to enter the first-person shooter market. Instead of licensing the DOOM engine, like many competitors, LucasArts created its own internal Jedi engine. The Jedi engine contains advanced features over similar tech, including the ability to look up and down, jump, crouch, and limited support (in the build used for Dark Forces) for rooms (sectors) over rooms. The 3D models also make occasional appearances inside the game, as turrets or Kyle's ship dropping him off or picking him up from each mission.<br>",
		descriptionShort:
			'Hokey religions and ancient weapons are no match for a good BLASTER',
		cover:
			'/bilder/artiklar/liten/PS-star-wars-dark-forces-_S.jpg?m=1604303675',
	},
	{
		artnr: 'PS-spyro-year-of-the-drag',
		product: 'Spyro: Year of the Dragon',
		description:
			'The third in the Playstation Spyro the Dragon series sees Spyro having to recover a clutch of Dragon eggs from the evil Sorceress.<br><br>The player can now play as not only Spyro, but Agent 9 the Space Monkey, Sheila the Kangaroo, Bentley the Yeti, Sgt. Byrd the Penguin and his two best friends Sparx and Hunter. Sparx has his own levels for the very first time. Also, Spyro has learned a few new abilities, including skateboarding!<br>',
		descriptionShort:
			'Spyro the Dragon, and his best friend Sparx, face a journey into uncharted territory against his most fearsome enemy yet — the Sorceress!',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-SPYRO1',
		product: 'Spyro the Dragon',
		description:
			"Spyro the Dragon is a 3D platform game - the player controls the titular character as he ventures across the realms of the Dragon World to defeat the Gnasty Gnorc, as well as rescue his fellow dragons and recover all of their stolen treasure.Worlds consist of six dragon 'home worlds', each of which acts as a dedicated HUB, containing portals that serve as gateways to different levels. The player must progress from one Homeworld to the next by talking to a balloonist, who transports Spyro to the next world on a hot air balloon after the player has found the required collectibles in the current given world. In addition to regular platforming stages, each Homeworld contains a boss fight and a hidden flight stage that involves flying throughout an environment and destroying a number of objects.",
		descriptionShort:
			'Control Spyro the Dragon as he ventures across the realms of the Dragon World to defeat the Gnasty Gnorc',
		cover: '/bilder/artiklar/liten/PS-SPYRO1_S.jpg?m=1602746267',
	},
	{
		artnr: 'PS-spyro-2-riptos-rage',
		product: "Spyro 2: Ripto's Rage!",
		description:
			'Like the original Spyro the Dragon, this is a platform-adventure game. Whilst using a portal to travel to the coast, he is enlisted to help a professor defeat Ripto the dinosaur.<br><br>The game is split into 3 worlds - on each of these Spyro must collect all the gems and then kill a boss. Level layouts are less linear and more expansive than many platform games, with lots of sub-quests - exploration is required.<br><br>This time around, the fantasy 3D worlds are larger and more complex. Though most of the gameplay elements from the original game have remained, more puzzle elements and bonus levels have been added to this chapter. Spyro has a new ground-pounding move.<br>',
		descriptionShort: 'Mess with this Dragon and Feel the Burn!',
		cover: '/bilder/artiklar/liten/PS-spyro-2-riptos-rage_S.jpg?m=1604303029',
	},
	{
		artnr: 'PS-spider-man-2-enter-ele',
		product: 'Spider-Man 2: Enter Electro',
		description:
		...
		cover:
			'/bilder/artiklar/liten/PS-spider-man-2-enter-ele_S.jpg?m=1604303011',
	},
	{
		artnr: 'PS-spider-man-2000',
		product: 'Spider-Man (2000)',
		description:
			"Spider-Man, the classic comic book co-created by Stan Lee, is now a major motion picture. This conversion of the movie to the video game world takes the major storyline, characters and artwork of the Spider-Man movie and adds a lengthy backstory and new characters.<br><br>The Green Goblin is the main villain here, and as Peter Parker you must defy gravity using your spider crawl, web-slinging and spider-sense abilities to track down Spidey's nemesis through the skyscapers of New York City.<br>",
		descriptionShort:
			'Move through stunning scenes from the movie as you explore enormous city environments with newfound maneuverability',
		cover: '/bilder/artiklar/liten/PS-spider-man-2000_S.jpg?m=1604302995',
	},
	{
		artnr: 'PS-simcity-2000',
		...
		cover: '/bilder/artiklar/liten/PS-simcity-2000_S.jpg?m=1604304069',
	},
	{
		artnr: 'PS-silent-hill',
		product: 'Silent Hill',
		description:
			"Harry Mason, an average man, is driving to the town of Silent Hill with his daughter. Upon approaching the town, a cop speeds by on a motorcycle. When Harry gets closer to town, he sees that same motorcycle sprawled in the middle of the road. Harry also spots a woman standing in the road, but due to the dense fog, he can't stop in time, so he swerves to avoid her, crashing into a railing, knocking him unconscious.<br><br>When Harry wakes up, his daughter, Cheryl, is missing. Sensing that she would head to the town to seek help, Harry sets out on a journey, not knowing what to expect from this eerie town, enshrouded with fog.<br><br>You play Harry Mason, a normal man, with no powers or training of any kind. You must search through the town of Silent Hill, looking for your daughter. You will come across many people, some friendly, some not. You must visit many different areas, such as the school, and the church.<br><br>Will Harry find his daughter and safely get out, or is there more to this town than a simple fog layer?<br>",
		descriptionShort:
			'Guide Harry as he explores the town to find his daughter and discover what is going on in this strange community',
		cover: '/bilder/artiklar/liten/PS-silent-hill_S.jpg?m=1602841838',
	},
	{
		artnr: 'PS-shadow-man',
		product: 'Shadow Man',
	...
	},
	{
		...
		product: 'Pokémon',
		description:
			"Become the greatest Pokémon trainer in the world! Start your Pokémon Game Boy adventure by choosing a tame Pokémon at the home of the great Pokémon master Professor Oak. Then start your journey.<br><br>Your mission: Collect all 150 Pokémon, just like Ash, using your own Pokémon to capture others. Along the way, several skilled trainers, such as Gary, and many minor trainers will challenge you to Pokémon duels. You can't back down, so be ready for anything!<br><br>Remember, Pokémon are not ordinary creatures. To collect all 150, you'll need to train captured Pokémon so they evolve. For instance, a captured Caterpie will evolve into a Metapod, which will then turn into a Butterfree. Each transformation adds more power to the Pokémon-giving you more power to defeat and capture other Pokémon.<br>",
		descriptionShort:
		...
		cover: '/bilder/artiklar/liten/GB-POKEGEN1_S.jpg?m=1602668368',
	},
	{
		artnr: 'PS-point-blank',
		product: 'Point Blank',
		description:
			'Point Blank is a light gun arcade game, in which players shoots targets in a wide variety of stages. The Playstation version uses the G-Con gun, for action similar to Time Crisis, also by Namco.<br><br>The game has a distinct cartoon theme and is non-violent, making it suitable for all ages. Each stage has a different objective, explained at the start of each stage. This varies from simple target shooting (and avoid to shoot bomb), shooting cardboard villains (avoid shooting cardboard civilians), shooting own color targets (avoid shooting opposing players color), protecting the iconic Dr.Don and Dr. Dan, and many miscellaneous challenges such as the Galaxian stage where lightgun is used in place of spaceships to shoot aliens.<br><br>The stages are presented in groups of 4 and the player or players can choose in which order to play them. You lose a life-heart when you shoot an incorrect target or bomb, or when you fail to complete a mission within the time limit.<br><br>As well as converting the arcade game in its entirety, this conversion also offers a new Quest mode, a Party Play system and more.<br>',
		descriptionShort:
			'About as much fun as you can have whilst keeping your clothes on!',
		cover: '/bilder/artiklar/liten/PS-point-blank_S.jpg?m=1604303864',
	},
	{
		artnr: 'PS-parasite-eve',
		product: 'Parasite Eve',
		description:
			"An ordinary day in New York for rookie police officer Aya Brea. Christmas Eve is the present day, and you've decided to visit the opera theater. Now this is where the fireworks begin. Suddenly audience members are set on fire, toasted completely, and it appears that the lead vocal is the source of this burning terror. Yet you appear to be immune, and as a police officer you're always on duty, so you must confront the danger.<br><br>There has to be some connection between the two of you, as that seems the only rational explanation. What if mitochondria are a species on its own, more advanced then humankind, and using them only to create environments and civilization for themselves? What if humankind are just hosts? What if mitochondria are the natural enemy of humankind? That would make Aya their natural enemy, so the battle for survival and uncovering the truth has already started.<br><br>The game is played over six days, each day bringing its own quest. Environments range from Central Park and the American Museum of Natural History to a police office and hospital, all of them modeled like realistic places and most of them crawling with bloodthirsty mutant animals. Combat is different from traditional RPGs, as while you still take turns attacking and/or using parasite powers, you'll be able to run across the battlefield and dodge enemy fire or even strike from a better angle or behind. As Aya levels up she will gain access to parasite powers, such as healing or supercharging a bullet with energy. These powers will deplete a recharging energy bar, although the bar will recharge slower the longer combat drags on. Aya will find many guns of various types throughout the game, and every gun can be modified with extra stats, either with special items, or by breaking down another gun to move over its bonus stats or special effects. The same is true for armor Aya finds.<br>",
		descriptionShort:
			'One of them is a police officer. The other is possessed by an ancient evil threatening all life on Earth.',
		cover: '/bilder/artiklar/liten/PS-parasite-eve_S.jpg?m=1604303961',
	},
	{
		artnr: 'PS-pandemonium',
		product: 'Pandemonium!',
		description:
		...
		descriptionShort:
			"Jump into the Action with Crystal Dynamics' Pandemonium!",
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-oddworld-abes-oddysee',
		product: "Oddworld: Abe's Oddysee",
		description:
		...
		descriptionShort:
			'In a world run by ruthless meat barons, your entire race is about to become pie filling...',
		cover: '/bilder/artiklar/liten/PS-oddworld-abes-oddysee_S.jpg?m=1603087815',
	},
	{
		artnr: 'PS-oddworld-abes-exoddus',
		product: "Oddworld: Abe's Exoddus",
		description:
		...
		descriptionShort: 'ODD things are happening at SoulStorm’ Brewery',
		cover: '/bilder/artiklar/liten/PS-oddworld-abes-exoddus_S.jpg?m=1603087887',
	},
	{
		artnr: 'PS-need-for-speed-porsche',
		product: 'Need for Speed: Porsche Unleashed',
		description:
		...
		descriptionShort: "You've pushed yourself to the edge - now drive over it!",
		cover:
			'/bilder/artiklar/liten/PS-need-for-speed-porsche_S.jpg?m=1604304056',
	},
	{
		artnr: 'PS-need-for-speed-high-st',
		product: 'Need for Speed: High Stakes',
		description:
		...
		descriptionShort: 'Rally driving takes to the high road!',
		cover:
			'/bilder/artiklar/liten/PS-need-for-speed-high-st_S.jpg?m=1603088000',
	},
	{
		artnr: 'PS-need-for-speed-3-hot-p',
		product: 'Need for Speed 3: Hot Pursuit',
		description:
		...
		descriptionShort: 'Race on both sides of the law with Hot Pursuit mode',
		cover:
			'/bilder/artiklar/liten/PS-need-for-speed-3-hot-p_S.jpg?m=1604304460',
	},
	{
		artnr: 'PS-need-for-speed-2',
		product: 'Need for Speed 2',
		description:
		...
		cover: '/bilder/artiklar/liten/PS-need-for-speed-2_S.jpg?m=1604303973',
	},
	{
		artnr: 'PS-myst',
		product: 'Myst',
		...
		descriptionShort:
			'Unveil a chilling tale of intrigue and injustice as you explore the mystery and grandeur of a soulless island.',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-mortal-kombat-4',
		product: 'Mortal Kombat 4',
		description:
		...
		descriptionShort: 'That which calls the warriors summons the vultures',
		cover: '/bilder/artiklar/liten/PS-mortal-kombat-4_S.jpg?m=1603087972',
	},
	{
		artnr: 'PS-mortal-kombat-3',
		product: 'Mortal Kombat 3',
		description:
		...
		descriptionShort: 'Grab the third tidal wave of karnage and mystery!',
		cover: '/bilder/artiklar/liten/PS-mortal-kombat-3_S.jpg?m=1603087786',
	},
	{
		artnr: 'PS-mortal-kombat-2',
		product: 'Mortal Kombat 2',
		description:
		...
		descriptionShort:
			'ALL the fierce kombatants of the #1 arcade smash gather for Mortal Kombat® II',
		cover: '/bilder/artiklar/liten/PS-mortal-kombat-2_S.jpg?m=1603087764',
	},
	{
		artnr: 'PS-metal-slug',
		product: 'METAL SLUG',
		description:
			"Metal Slug, originally released on the Neo Geo, is a side-scrolling shoot'em'up.<br><br>The player(s) takes the role of a soldier (or two) and fights a gigantic army. Every level consists of running forward blasting anything that moves, while collecting power-ups along the way (there's also a wide selection of weaponry in the game). In the end of each level the player goes up against one gigantic boss.<br><br>The PlayStation port introduces some extra features: there is a combat school where the player may fight with other players for the best time on each level and an art gallery.<br>",
		descriptionShort:
			'The very first title in SNK’s legendary 2D run & gun action shooting game series where it all began',
		cover: '/bilder/artiklar/liten/PS-metal-slug_S.jpg?m=1604304298',
	},
	{
		artnr: 'PS-metal-gear-solid-1',
		...
		descriptionShort:
			'Infiltrate a terrorist stronghold to crack a nuclear conspiracy',
		cover: '/bilder/artiklar/liten/PS-metal-gear-solid-1_S.jpg?m=1604304217',
	},
	{
		artnr: 'PS-medievil',
		product: 'MediEvil',
		description:
			'In the year 1286, Sir Daniel Fortesque and his soldiers fought against the evil sorcerer Zarok, who raised an army of demons, intending to conquer the world. Sir Daniel was hailed as a hero after the battle, supposedly having been mortally wounded during it, taking Zarok with him. However, it looks like the sorcerer was not defeated in that battle. A hundred years later, he appears again, robbing people of their souls to build an army of undead. Unleashing waves of necromantic energy, Zarok inadvertently revives Sir Daniel as well. Now a skeletal corpse, the knight must correct the mistakes of the past and defeat Zarok once and for all.',
		descriptionShort:
			'Follow the mystical trial of darkness and land in the journey of a lifetime',
		cover: '/bilder/artiklar/liten/PS-medievil_S.jpg?m=1603087739',
	},
	{
		artnr: 'PS-medal-of-honor-1999',
		product: 'Medal of Honor',
		description:
		...
		descriptionShort: 'Tomorrow is D-Day. Tonight you land behind enemy lines',
		cover: '/bilder/artiklar/liten/PS-medal-of-honor-1999_S.jpg?m=1604303984',
	},
	{
		artnr: 'PS-mdk',
		product: 'MDK',
		...
		descriptionShort: 'It thinks. Therefore it kills.',
		cover: '/bilder/artiklar/liten/PS-mdk_S.jpg?m=1604304278',
	},
	{
		artnr: 'PS-little-big-adventure-r',
		product: "Little Big Adventure (Relentless: Twinsen's Adventure)",
		description:
		...
		descriptionShort:
			'Meet strange beings, solve cryptic clues and defeat mean bad guys as you guide Twinsen to his destiny.',
		cover:
			'/bilder/artiklar/liten/PS-little-big-adventure-r_S.jpg?m=1604303940',
	},
	{
		artnr: 'PS-legacy-of-kain-soul-re',
		product: 'Legacy of Kain: Soul Reaver',
		description:
		...
		cover:
			'/bilder/artiklar/liten/PS-legacy-of-kain-soul-re_S.jpg?m=1604304242',
	},
	{
		artnr: 'PS-hexen-for-windows-95',
		product: 'HeXen: Beyond Heretic',
		description:
			"Hexen is the sequel to Heretic. While the Heretic was destroying D'Sparil, the other two Serpent Riders have come to your dimension and slaughtered everyone. Or so they thought. Three humans have managed to escape with their lives and now seek vengeance against the Serpent Rider Korax who remains in their world.<br><br>Like Heretic, Hexen is a fantasy game based on an enhanced DOOM engine. All of Heretic's innovations like vertical looking, flying, and the inventory system have been carried over. The new major changes this time around are three characters for the player to choose from and the level hub system. The characters are the Fighter, the Cleric, and the Mage. Each one has four unique weapons and different levels of speed and armor.<br>",
		descriptionShort: ' Walk. Run. Fly. Look all around. Inflict serious pain.',
		cover: '/bilder/artiklar/liten/PS-hexen-for-windows-95_S.jpg?m=1604304359',
	},
	{
		artnr: 'PS-harry-potter-and-the-p',
		product: "Harry Potter and the Philosopher's Stone",
		description:
			"Fans of the phenomenon that is Harry Potter will no doubt be eagerly awaiting the next instalment of the videogame version of wizardry and witchcraft, and luckily for them, EA never rests on its laurels. After the storming success of The Chamber of Secrets, the publisher has teamed up with Warthog Games to bring PS one classic Harry Potter and the Philosipher's Stone to PS2, complete with all of the graphical advantages afforded by the world's favourite console. Following the storyline of the original game, Harry Potter and the Philosipher's Stone sees the bespectacled spell-caster returning to his educational origins at Hogwart's for another bout of magical high-jinks.<br><br>Take up the wonder-boy's wand in a tale of spells and sorcery, closely tied in with JK Rowling's book of the same name, and encounter familiar characters along the way. Harry's friends Ron Weasley and Hermione Granger are on hand to help the apprentice alchemist out, Professor Dumbledore and Hagrid both make appearances, and arch-enemy Draco Malfoy attempts to thwart the young wizard at every turn. Attend classes to learn how to create potions and cast spells, jump on your broomstick and lead the home team to glory in Quidditch, and explore the school's many cavernous corridors and secret passageways in search of the fabled Philosopher's Stone.<br>",
		descriptionShort:
			'Leave the nonmagical world of behind and enroll in Hogwarts School of Witchcraft and Wizardry',
		cover:
			'/bilder/artiklar/liten/PS-harry-potter-and-the-p_S.jpg?m=1604303795',
	},
	{
		artnr: 'PS-harry-potter-and-the-c',
		product: 'Harry Potter and the Chamber of Secrets',
		description:
			"Harry Potter and the Chamber of Secrets follows the exploits of Harry during his second year at the Hogwarts School of Witchcraft and Wizardry. During his time there, Harry's classmates are coming under a mysterious paralysis and Harry must get to the bottom of what is happening.",
		descriptionShort:
			'Guide Harry Potter in a new adventure with more magic, friendship and danger',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-grand-theft-auto-2-199',
	...
	},
	{
		...
		cover: '/bilder/artiklar/liten/PS-gran-turismo-2_S.jpg?m=1604303873',
	},
	{
		artnr: 'PS-gran-turismo',
		...
		descriptionShort: 'Feel the power of 140 authentic sports cars!',
		cover: '/bilder/artiklar/liten/_bild_saknas.gif?m=1585817252',
	},
	{
		artnr: 'PS-final-fantasy-viii',
		product: 'FINAL FANTASY VIII',
		description:
			"It is a time of war.<br>The Republic of Galbadia, under the influence of the sorceress Edea, mobilises its great armies against the other nations of the world.<br>Squall and other members of SeeD, an elite mercenary force, join hands with Rinoa, a resistance fighter, to fight against Galbadia's tyrannical rule and to prevent Edea from fulfilling her ultimate goal.<br>",
		descriptionShort:
			"Fight against Galbadia's tyrannical rule and to prevent Edea from fulfilling her ultimate goal",
		cover: '/bilder/artiklar/liten/PS-final-fantasy-viii_S.jpg?m=1604302909',
	},
	{
		artnr: 'PS-final-fantasy-vii',
		product: 'Final Fantasy VII',
		description:
			"In Midgar, a city controlled by the mega-conglomerate Shinra Inc., the No. 1 Mako Reactor has been blown up by a rebel group, AVALANCHE.<br><br>AVALANCHE was secretly formed to wage a rebellion against Shinra Inc., an organisation which is absorbing Mako energy, destroying the natural resources of the planet. Cloud, a former member of Shinra's elite combat force, SOLDIER, was involved with the bombing of the Mako Reactor.<br><br>Can Cloud and AVALANCHE protect the planet from the huge, formidable enemy, Shinra Inc.?<br>",
		descriptionShort:
			'Can Cloud and AVALANCHE protect the planet from the huge, formidable enemy, Shinra Inc.?',
		cover: '/bilder/artiklar/liten/PS-final-fantasy-vii_S.jpg?m=1604302892',
	},
	{
		artnr: 'PS-final-fantasy-vi',
		product: 'FINAL FANTASY VI',
		description:
			"The War of Magi left little but ashes and misery in its wake. Even magic itself had vanished from the world. Now, a thousand years later, humankind has remade the world through the power of iron, gunpowder, steam engines, and other machines and technologies.<br><br>But there is one who possesses the lost power of magic--a young girl name Terra whom the evil Empire has kept enslaved in an effort to harness her power as weapon. This leads to a fateful meeting between Terra and a young man named Locke. Their harrowing escape from the Empire's clutches sets in motion a series of events that touches countless lives and leads to one inevitable conclusion.<br>",
		descriptionShort:
			'Humankind has remade the world through the power of iron, gunpowder, steam engines, and other machines and technologies.<br>',
		cover: '/bilder/artiklar/liten/PS-final-fantasy-vi_S.jpg?m=1604302870',
	},
	{
		artnr: 'PS-final-fantasy-v',
		product: 'FINAL FANTASY V',
		description:
	...
	},
	{
		...
		cover: '/bilder/artiklar/liten/PS-final-fantasy_S.jpg?m=1604303854',
	},
	{
		artnr: 'PS-final-doom',
		product: 'Final DOOM',
		...
		descriptionShort:
			'Final DOOM for PlayStation is a compilation of 30 levels from the PC version of Final DOOM and the Master Levels.',
		cover: '/bilder/artiklar/liten/PS-final-doom_S.jpg?m=1604304286',
	},
	{
		artnr: 'PS-earthworm-jim-2',
		product: 'Earthworm Jim 2',
		description:
		...
		descriptionShort: 'Take the bait and enjoy this wacky platformer.',
		cover: '/bilder/artiklar/liten/PS-earthworm-jim-2_S.jpg?m=1604304048',
	},
	{
		artnr: 'PS-duke-nukem-3d',
	...
	},
	{
		...
		descriptionShort:
			'3D platforming adventure game in which the player, as Donkey Kong and his friends, explores an island and collects items to progress through minigames and puzzles.',
		cover: '/bilder/artiklar/liten/N64-DK64_S.jpg?m=1602660696',
	},
	{
		artnr: 'PS-disneys-tarzan',
		product: "Disney's Tarzan",
		description:
			"Overcome the jungle's most dangerous perils in this action-packed adventure. Relive Tarzan's journey through life from a headstrong youth to a courageous adult. Interact with unique characters, ride on elephants, solve challenging puzzles and surf on trees. Master the moves of this ultimate jungle hero.",
		descriptionShort: 'Master the moves of this ultimate jungle hero.',
		cover: '/bilder/artiklar/liten/PS-disneys-tarzan_S.jpg?m=1604303720',
	},
	{
		artnr: 'PS-disneys-hercules',
		product: "Disney's Hercules: The Action Game",
		description:
		...
		descriptionShort: 'Become a true hero in a battle of mythic proportions.',
		cover: '/bilder/artiklar/liten/PS-disneys-hercules_S.jpg?m=1604304122',
	},
	{
		artnr: 'PS-dino-crisis-2-2000',
		product: 'Dino Crisis 2',
		description:
		...
		descriptionShort: "They're bigger, faster, smarter. AND RIGHT BEHIND YOU.",
		cover: '/bilder/artiklar/liten/PS-dino-crisis-2-2000_S.jpg?m=1604303781',
	},
	{
		artnr: 'PS-dino-crisis',
		product: 'Dino Crisis',
		description:
		...
		descriptionShort:
			'A desperate fight for survival against the most terrifying predators to ever walk the earth.',
		cover: '/bilder/artiklar/liten/PS-dino-crisis_S.jpg?m=1604303815',
	},
	{
		artnr: 'PS-diablo',
		product: 'Diablo',
		...
		descriptionShort:
			'Embark if you dare on a quest to destroy the lord of all evil.',
		cover: '/bilder/artiklar/liten/PS-diablo_S.jpg?m=1603087681',
	},
	{
		artnr: 'PS-deathtrap-dungeon',
		product: 'Deathtrap Dungeon',
		description:
		...
		descriptionShort:
			'Experience intense multiplayer action as you dive into the macabre and devilish 3D realm of Deathtrap Dungeon.',
		cover: '/bilder/artiklar/liten/PS-deathtrap-dungeon_S.jpg?m=1604304079',
	},
	{
		artnr: 'PS-darkstone',
		product: 'DARKSTONE',
		description:
			"The Evil Draak has joined forces with Death and is destroying everything in his path! Explore huge keeps to find the 7 Legendary Crystals to put an end to his vile acts. It is highly unlikely that you'll be able to survive in the hostile regions of this desolate land. Be warned, the fighting will be fierce, but the adventure will be epic!Join the best warriors now and pool your skills to ensure that Good triumphs over Evil!Key Features:Replay as much as you like thanks to the 4 difficulty levels and the randomly generated dungeons, quests and items.Play in cooperative mode with up to three of your friends for highly intense fights.Choose from 8 characters from 4 different classes (warrior, wizard, thief and monk) with their own unique features, combat styles and defeat your fire breathing nemesis.Upgrade your skills, choose among more than 30 sorts of weapons, 32 magic spells and progress through an epic adventure in 32 different environments.",
		descriptionShort:
			'Dive into the world of Darkstone and free the hero within you',
		cover: '/bilder/artiklar/liten/PS-darkstone_S.jpg?m=1609759542',
	},
	{
		artnr: 'PS-crusader-no-remorse',
		product: 'Crusader: No Remorse',
		description:
		...
		descriptionShort:
			'You are a Silencer, an elite enforcer for the World Economic Consortium. The work you do is for the good of the world, or so you believe until discovering the corruption of the Consortium.',
		cover: '/bilder/artiklar/liten/PS-crusader-no-remorse_S.jpg?m=1609759456',
	},
	{
		artnr: 'PS-CRASHRACE',
		product: 'Crash Team Racing',
		description:
			"It is the fourth installment in the Crash Bandicoot series. The game's story focuses on the efforts of Crash Bandicoot, Doctor Neo Cortex, and other ragtag team of characters in the Crash Bandicoot series, who must race against the egomaniacal Nitros Oxide to save the Earth from destruction. In the game, players can take control of one of fifteen Crash Bandicoot series characters, though only eight are available at first. During the races, offensive and speed boosting power ups can be used to gain an advantage.",
		descriptionShort:
			"It's a multi-player kart racing game starring your favorite bandicoot, CRASH and a host of his friends... and foes!",
		cover: '/bilder/artiklar/liten/PS-CRASHRACE_S.jpg?m=1602667857',
	},
	{
		artnr: 'PS-crash-bandicoot-warped',
		product: 'Crash Bandicoot 3: Warped',
		description:
			"The third title in Sony's popular Crash Bandicoot series, Crash Bandicoot 3 is the first to feature Coco as a playable character, and uses the 'tunnel' 3D popularized in the earlier Crash games.As in Crash Bandicoot 2 you have to collect 25 crystals that are scattered across time before your enemy Dr. Neo Cortex does. But this time the evil witch doctor Uka Uka is with Cortex to find the crystals and take over the world. With help from N. Tropy they build a Time Twister Machine to travel through time with. Crash and Coco must also use the Time Twister for gathering crystals, as usual with the help from the good witch doctor Aku Aku.But there are also 42 gems scattered across time, just like in Crash 2. You must find them as well in order to complete the game. When you have collected all of the 25 crystals, then you can take on Cortex and Uka Uka.",
		descriptionShort:
			'Insane Dr. Cortex has recruited N. Tropy, Master of Time, in another mad attempt to take over the World.',
		cover:
			'/bilder/artiklar/liten/PS-crash-bandicoot-warped_S.jpg?m=1604304368',
	},
	{
		artnr: 'PS-crash-bandicoot-2',
		product: 'Crash Bandicoot 2: Cortex Strikes Back',
		description:
		...
		descriptionShort:
			'The evil Dr. Neo Cortex is back with a vengeance... this time... to save the world?',
		cover: '/bilder/artiklar/liten/PS-crash-bandicoot-2_S.jpg?m=1604304388',
	},
	{
		artnr: 'PS-CRASH1',
		product: 'Crash Bandicoot',
		description:
		...
		cover: '/bilder/artiklar/liten/PS-CRASH1_S.jpg?m=1602664973',
	},
	{
		artnr: 'PS-command-conquer-red-al',
		product: 'Command & Conquer: Red Alert',
		description:
		...
		descriptionShort:
			'In the newest addition to the COMMAND & CONQUER franchise, Hitler never came to power. Instead, it is Stalin whose maniacal quest for power must be stopped as his ruthless troops march across Europe.',
		cover:
			'/bilder/artiklar/liten/PS-command-conquer-red-al_S.jpg?m=1609759094',
	},
	{
		artnr: 'PS-chrono-trigger-1995',
	...
	},
	{
		...
		descriptionShort:
			'The ORIGINATOR of Survival HORROR is Back! And it’s Scarier than ever!',
		cover:
			'/bilder/artiklar/liten/PS-alone-in-the-dark-the-_S.jpg?m=1602841953',
	},
	{
		artnr: 'PS-alone-in-the-dark-2-19',
		product: 'Alone in the Dark 2',
		description:
		...
		cover:
			'/bilder/artiklar/liten/PS-alone-in-the-dark-2-19_S.jpg?m=1602841905',
	},
]
