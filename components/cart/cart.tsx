...
const Cart = () => {
  ...
  return (
    <>
      <div
        className={`sticky w-full md:w-20 bottom-0 flex items-center md:items-end left-0 mb-20 ml-0 flex-col md:flex-row md:ml-10 pointer-events-none right-0 max-h-screen transform ${isActive && 'md:scale-110'}`}
        ref={drop}
      >
        <div
        ...
        <OutsideCloseCart>
          <div
            className={`text-center bg-white rounded-lg pt-10 pb-4 px-4 flex flex-col items-center justify-start w-auto shadow-lg pointer-events-auto md:ml-4 mb-2 overflow-y-scroll  md:mb-6 bg-opacity-95 border border-blue-400 order-1 md:order-2 ${
              ...
              {state && state.length === 0 ? (
                ...
                state && (
                  <div className="flex w-64 justify-end flex-wrap">
                    ...
                    <div className="sticky w-full h-20 bg-white left-auto bottom-0">
